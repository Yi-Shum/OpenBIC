...
sensor_cfg plat_sensor_config[] = {
  ...
  pre_hook_fn, pre_hook_args, post_hook_fn, post_hook_args, init_arg */
	...
	// adc voltage
	{ SENSOR_NUM_VOL_STBY12V, sensor_dev_ast_adc, adc_port0, NONE, NONE, stby_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[0],
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_STBY3V, sensor_dev_ast_adc, adc_port2, NONE, NONE, stby_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[1],
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_STBY1V05, sensor_dev_ast_adc, adc_port3, NONE, NONE, stby_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[2],
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_BAT3V, sensor_dev_ast_adc, adc_port4, NONE, NONE, stby_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, pre_vol_bat3v_read, NULL, post_vol_bat3v_read, &ast_adc_post_args[3],
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_STBY5V, sensor_dev_ast_adc, adc_port9, NONE, NONE, stby_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[4],
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_DIMM12V, sensor_dev_ast_adc, adc_port11, NONE, NONE, DC_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[0],
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_STBY1V2, sensor_dev_ast_adc, adc_port13, NONE, NONE, stby_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[2],
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_M2_3V3, sensor_dev_ast_adc, adc_port14, NONE, NONE, DC_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[1],
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_STBY1V8, sensor_dev_ast_adc, adc_port15, NONE, NONE, stby_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[2],
	  &ast_adc_init_args[0] },
