...
IPMB_config pal_IPMB_config_table[] = {
	...
	{ BMC_IPMB_IDX,     I2C_IF,           BMC_IPMB_IFs,     IPMB_I2C_BMC,    BMC_I2C_ADDRESS,     Disable,   Self_I2C_ADDRESS,     "RX_BMC_IPMB_TASK",   "TX_BMC_IPMB_TASK"  },
	{ ME_IPMB_IDX,      I2C_IF,           ME_IPMB_IFs,      IPMB_ME_BUS,     ME_I2C_ADDRESS,      Disable,   Self_I2C_ADDRESS,     "RX_ME_IPMB_TASK",    "TX_ME_IPMB_TASK"   },
