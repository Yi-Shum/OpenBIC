...
sensor_cfg plat_sensor_config[] = {
	...
	// adc
	{ SENSOR_NUM_VOL_P5V_STBY, sensor_dev_ast_adc, adc_port1, NONE, NONE, stby_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[0],
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_P12V_STBY, sensor_dev_ast_adc, adc_port0, NONE, NONE, stby_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[1],
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_P3V3_STBY, sensor_dev_ast_adc, adc_port2, NONE, NONE, stby_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[2],
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_P5V_USB, sensor_dev_ast_adc, adc_port7, NONE, NONE, stby_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[0],
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_P1V2_BIC_STBY, sensor_dev_ast_adc, adc_port5, NONE, NONE, stby_access, 0,
	  0, 0, SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[3],
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_P1V0_STBY, sensor_dev_ast_adc, adc_port4, NONE, NONE, stby_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[3],
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_CUR_P12V_FAN, sensor_dev_ast_adc, adc_port6, NONE, NONE, stby_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, post_ast_adc_read, &ast_adc_post_args[3],
	  &ast_adc_init_args[0] },
