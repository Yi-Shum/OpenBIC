...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_TEMP_DIMM_A, sensor_dev_ddr5_temp, I2C_BUS11, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, post_ddr5_temp_read, NULL, &ddr5_init_temp_args[0] },
	{ SENSOR_NUM_TEMP_DIMM_B, sensor_dev_ddr5_temp, I2C_BUS11, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, post_ddr5_temp_read, NULL, &ddr5_init_temp_args[1] },
	{ SENSOR_NUM_TEMP_DIMM_C, sensor_dev_ddr5_temp, I2C_BUS11, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, post_ddr5_temp_read, NULL, &ddr5_init_temp_args[2] },
	{ SENSOR_NUM_TEMP_DIMM_E, sensor_dev_ddr5_temp, I2C_BUS11, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, post_ddr5_temp_read, NULL, &ddr5_init_temp_args[3] },
	{ SENSOR_NUM_TEMP_DIMM_G, sensor_dev_ddr5_temp, I2C_BUS12, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, post_ddr5_temp_read, NULL, &ddr5_init_temp_args[4] },
	{ SENSOR_NUM_TEMP_DIMM_H, sensor_dev_ddr5_temp, I2C_BUS12, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, post_ddr5_temp_read, NULL, &ddr5_init_temp_args[5] },
	{ SENSOR_NUM_TEMP_DIMM_I, sensor_dev_ddr5_temp, I2C_BUS12, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, post_ddr5_temp_read, NULL, &ddr5_init_temp_args[6] },
	{ SENSOR_NUM_TEMP_DIMM_K, sensor_dev_ddr5_temp, I2C_BUS12, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	...
	{ SENSOR_NUM_PWR_DIMM_A, sensor_dev_ddr5_power, I2C_BUS11, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, post_ddr5_pwr_read, NULL, &ddr5_init_power_args[0] },
	{ SENSOR_NUM_PWR_DIMM_B, sensor_dev_ddr5_power, I2C_BUS11, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, post_ddr5_pwr_read, NULL, &ddr5_init_power_args[1] },
	{ SENSOR_NUM_PWR_DIMM_C, sensor_dev_ddr5_power, I2C_BUS11, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, post_ddr5_pwr_read, NULL, &ddr5_init_power_args[2] },
	{ SENSOR_NUM_PWR_DIMM_E, sensor_dev_ddr5_power, I2C_BUS11, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, post_ddr5_pwr_read, NULL, &ddr5_init_power_args[3] },
	{ SENSOR_NUM_PWR_DIMM_G, sensor_dev_ddr5_power, I2C_BUS12, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, post_ddr5_pwr_read, NULL, &ddr5_init_power_args[4] },
	{ SENSOR_NUM_PWR_DIMM_H, sensor_dev_ddr5_power, I2C_BUS12, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, post_ddr5_pwr_read, NULL, &ddr5_init_power_args[5] },
	{ SENSOR_NUM_PWR_DIMM_I, sensor_dev_ddr5_power, I2C_BUS12, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, post_ddr5_pwr_read, NULL, &ddr5_init_power_args[6] },
	{ SENSOR_NUM_PWR_DIMM_K, sensor_dev_ddr5_power, I2C_BUS12, NONE, NONE, post_access, 0, 0,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
