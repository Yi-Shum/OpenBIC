...
sensor_cfg plat_sensor_config[] = {
	/* number, type, port, address, offset, access check, arg0, arg1,
	   cache, cache_status, pre_sensor_read_fn, pre_sensor_read_args,
	   post_sensor_read_fn, post_sensor_read_fn, init_arg */
	...
	//   0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	// { SENSOR_NUM_TEMP_DIMM_C, sensor_dev_amd_dimm_temp, I2C_BUS10, APML_ADDR, NULL, post_access,
	//   0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	// { SENSOR_NUM_TEMP_DIMM_E, sensor_dev_amd_dimm_temp, I2C_BUS10, APML_ADDR, NULL, post_access,
	//   0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	// { SENSOR_NUM_TEMP_DIMM_G, sensor_dev_amd_dimm_temp, I2C_BUS10, APML_ADDR, NULL, post_access,
	//   0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	// { SENSOR_NUM_TEMP_DIMM_H, sensor_dev_amd_dimm_temp, I2C_BUS10, APML_ADDR, NULL, post_access,
	//   0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	// { SENSOR_NUM_TEMP_DIMM_I, sensor_dev_amd_dimm_temp, I2C_BUS10, APML_ADDR, NULL, post_access,
	//   0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	// { SENSOR_NUM_TEMP_DIMM_K, sensor_dev_amd_dimm_temp, I2C_BUS10, APML_ADDR, NULL, post_access,
	//   0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	// { SENSOR_NUM_PWR_CPU, sensor_dev_amd_cpu_pwr, I2C_BUS10, APML_ADDR, NULL, post_access, 0, 0,
	//   SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	// { SENSOR_NUM_TEMP_DIMM_A, sensor_dev_amd_dimm_pwr, I2C_BUS10, APML_ADDR, NULL, post_access,
	//   0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	// { SENSOR_NUM_TEMP_DIMM_B, sensor_dev_amd_dimm_pwr, I2C_BUS10, APML_ADDR, NULL, post_access,
	//   0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	// { SENSOR_NUM_TEMP_DIMM_C, sensor_dev_amd_dimm_pwr, I2C_BUS10, APML_ADDR, NULL, post_access,
	//   0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	// { SENSOR_NUM_TEMP_DIMM_E, sensor_dev_amd_dimm_pwr, I2C_BUS10, APML_ADDR, NULL, post_access,
	//   0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	// { SENSOR_NUM_TEMP_DIMM_G, sensor_dev_amd_dimm_pwr, I2C_BUS10, APML_ADDR, NULL, post_access,
	//   0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	// { SENSOR_NUM_TEMP_DIMM_H, sensor_dev_amd_dimm_pwr, I2C_BUS10, APML_ADDR, NULL, post_access,
	//   0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	...
	{ SENSOR_NUM_VOL_PVDD33_S5, sensor_dev_ast_adc, ADC_PORT5, NONE, NONE, dc_access, 2, 1,
	  SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_P5V_STBY, sensor_dev_ast_adc, ADC_PORT9, NONE, NONE, stby_access, 711, 200,
	  SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_P12V_MEM_1, sensor_dev_ast_adc, ADC_PORT10, NONE, NONE, dc_access, 66, 10,
	  SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_P12V_MEM_0, sensor_dev_ast_adc, ADC_PORT11, NONE, NONE, dc_access, 66, 10,
	  SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_P1V2_STBY, sensor_dev_ast_adc, ADC_PORT13, NONE, NONE, stby_access, 1, 1,
	  SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_P3V3_M2, sensor_dev_ast_adc, ADC_PORT14, NONE, NONE, dc_access, 2, 1,
	  SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_P1V8_STBY, sensor_dev_ast_adc, ADC_PORT15, NONE, NONE, stby_access, 1, 1,
	  SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &ast_adc_init_args[0] },
	...
	/* VR current */
	{ SENSOR_NUM_CUR_PVDDCR_CPU0_VR, sensor_dev_isl69259, I2C_BUS5, PVDDCR_CPU0_ADDR,
	  PMBUS_READ_IOUT, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_raa229621_read, &raa229621_pre_read_args[0], NULL, NULL, NULL },
	{ SENSOR_NUM_CUR_PVDDCR_SOC_VR, sensor_dev_isl69259, I2C_BUS5, PVDDCR_SOC_ADDR,
	  PMBUS_READ_IOUT, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_raa229621_read, &raa229621_pre_read_args[1], NULL, NULL, NULL },
	{ SENSOR_NUM_CUR_PVDDCR_CPU1_VR, sensor_dev_isl69259, I2C_BUS5, PVDDCR_CPU1_ADDR,
	  PMBUS_READ_IOUT, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_raa229621_read, &raa229621_pre_read_args[0], NULL, NULL, NULL },
	{ SENSOR_NUM_CUR_PVDDIO_VR, sensor_dev_isl69259, I2C_BUS5, PVDDIO_ADDR, PMBUS_READ_IOUT,
	  vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, pre_raa229621_read,
	  &raa229621_pre_read_args[1], NULL, NULL, NULL },
	{ SENSOR_NUM_CUR_PVDD11_S3_VR, sensor_dev_isl69259, I2C_BUS5, PVDD11_S3_ADDR,
	  PMBUS_READ_IOUT, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_raa229621_read, &raa229621_pre_read_args[0], NULL, NULL, NULL },

	/* VR temperature */
	{ SENSOR_NUM_TEMP_PVDDCR_CPU0_VR, sensor_dev_isl69259, I2C_BUS5, PVDDCR_CPU0_ADDR,
	  PMBUS_READ_TEMPERATURE_1, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_raa229621_read, &raa229621_pre_read_args[0], NULL, NULL, NULL },
	{ SENSOR_NUM_TEMP_PVDDCR_SOC_VR, sensor_dev_isl69259, I2C_BUS5, PVDDCR_SOC_ADDR,
	  PMBUS_READ_TEMPERATURE_1, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_raa229621_read, &raa229621_pre_read_args[1], NULL, NULL, NULL },
	{ SENSOR_NUM_TEMP_PVDDCR_CPU1_VR, sensor_dev_isl69259, I2C_BUS5, PVDDCR_CPU1_ADDR,
	  PMBUS_READ_TEMPERATURE_1, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_raa229621_read, &raa229621_pre_read_args[0], NULL, NULL, NULL },
	{ SENSOR_NUM_TEMP_PVDDIO_VR, sensor_dev_isl69259, I2C_BUS5, PVDDIO_ADDR,
	  PMBUS_READ_TEMPERATURE_1, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_raa229621_read, &raa229621_pre_read_args[1], NULL, NULL, NULL },
	{ SENSOR_NUM_TEMP_PVDD11_S3_VR, sensor_dev_isl69259, I2C_BUS5, PVDD11_S3_ADDR,
	  PMBUS_READ_TEMPERATURE_1, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_raa229621_read, &raa229621_pre_read_args[0], NULL, NULL, NULL },

	/* VR power */
	{ SENSOR_NUM_PWR_PVDDCR_CPU0_VR, sensor_dev_isl69259, I2C_BUS5, PVDDCR_CPU0_ADDR,
	  PMBUS_READ_POUT, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_raa229621_read, &raa229621_pre_read_args[0], NULL, NULL, NULL },
	{ SENSOR_NUM_PWR_PVDDCR_SOC_VR, sensor_dev_isl69259, I2C_BUS5, PVDDCR_SOC_ADDR,
	  PMBUS_READ_POUT, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_raa229621_read, &raa229621_pre_read_args[1], NULL, NULL, NULL },
	{ SENSOR_NUM_PWR_PVDDCR_CPU1_VR, sensor_dev_isl69259, I2C_BUS5, PVDDCR_CPU1_ADDR,
	  PMBUS_READ_POUT, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_raa229621_read, &raa229621_pre_read_args[0], NULL, NULL, NULL },
	{ SENSOR_NUM_PWR_PVDDIO_VR, sensor_dev_isl69259, I2C_BUS5, PVDDIO_ADDR, PMBUS_READ_POUT,
	  vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, pre_raa229621_read,
	  &raa229621_pre_read_args[1], NULL, NULL, NULL },
	{ SENSOR_NUM_PWR_PVDD11_S3_VR, sensor_dev_isl69259, I2C_BUS5, PVDD11_S3_ADDR,
	  PMBUS_READ_POUT, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_raa229621_read, &raa229621_pre_read_args[0], NULL, NULL, NULL },
