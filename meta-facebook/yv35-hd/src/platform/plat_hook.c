...
amd_apml_rmi_init_arg amd_apml_rmi_init_args[] = {
	[0] = { .data = 0x00000000 }, [1] = { .data = 0x00000002 }, [2] = { .data = 0x00000001 },
	[3] = { .data = 0x00000003 }, [4] = { .data = 0x00000010 }, [5] = { .data = 0x00000012 },
	[6] = { .data = 0x00000011 }, [7] = { .data = 0x00000013 },
};
