...
stat_machine_t fd_stat_machine[] = {
	/* QueryDeviceIdentifiers */
	{ PLDM_FW_UPDATE_CMD_CODE_QUERY_DEVICE_IDENTIFIERS, STATE_IDLE, STATE_IDLE },
	{ PLDM_FW_UPDATE_CMD_CODE_QUERY_DEVICE_IDENTIFIERS, STATE_LEARN_COMP, STATE_LEARN_COMP },
	{ PLDM_FW_UPDATE_CMD_CODE_QUERY_DEVICE_IDENTIFIERS, STATE_RDY_XFER, STATE_RDY_XFER },
	{ PLDM_FW_UPDATE_CMD_CODE_QUERY_DEVICE_IDENTIFIERS, STATE_DOWNLOAD, STATE_DOWNLOAD },
	{ PLDM_FW_UPDATE_CMD_CODE_QUERY_DEVICE_IDENTIFIERS, STATE_VERIFY, STATE_VERIFY },
	{ PLDM_FW_UPDATE_CMD_CODE_QUERY_DEVICE_IDENTIFIERS, STATE_APPLY, STATE_APPLY },
	{ PLDM_FW_UPDATE_CMD_CODE_QUERY_DEVICE_IDENTIFIERS, STATE_ACTIVATE, STATE_ACTIVATE },

	/* GetFirmwareParameters */
	{ PLDM_FW_UPDATE_CMD_CODE_GET_FIRMWARE_PARAMETERS, STATE_IDLE, STATE_IDLE },
	{ PLDM_FW_UPDATE_CMD_CODE_GET_FIRMWARE_PARAMETERS, STATE_LEARN_COMP, STATE_LEARN_COMP },
	{ PLDM_FW_UPDATE_CMD_CODE_GET_FIRMWARE_PARAMETERS, STATE_RDY_XFER, STATE_RDY_XFER },
	{ PLDM_FW_UPDATE_CMD_CODE_GET_FIRMWARE_PARAMETERS, STATE_DOWNLOAD, STATE_DOWNLOAD },
	{ PLDM_FW_UPDATE_CMD_CODE_GET_FIRMWARE_PARAMETERS, STATE_VERIFY, STATE_VERIFY },
	{ PLDM_FW_UPDATE_CMD_CODE_GET_FIRMWARE_PARAMETERS, STATE_APPLY, STATE_APPLY },
	...
	/* PassComponentTable */
	{ PLDM_FW_UPDATE_CMD_CODE_PASS_COMPONENT_TABLE, STATE_LEARN_COMP, STATE_LEARN_COMP },
	{ PLDM_FW_UPDATE_CMD_CODE_PASS_COMPONENT_TABLE, STATE_LEARN_COMP, STATE_RDY_XFER },

	/* UpdateComponent */
	{ PLDM_FW_UPDATE_CMD_CODE_UPDATE_COMPONENT, STATE_RDY_XFER, STATE_RDY_XFER },
	{ PLDM_FW_UPDATE_CMD_CODE_UPDATE_COMPONENT, STATE_RDY_XFER, STATE_DOWNLOAD },

	/* RequestFirmwareData */
	{ PLDM_FW_UPDATE_CMD_CODE_TRANSFER_COMPLETE, STATE_DOWNLOAD, STATE_DOWNLOAD },
	{ PLDM_FW_UPDATE_CMD_CODE_TRANSFER_COMPLETE, STATE_DOWNLOAD, STATE_IDLE },

	/* VerifyComplete */
	{ PLDM_FW_UPDATE_CMD_CODE_VERIFY_COMPLETE, STATE_VERIFY, STATE_VERIFY },
	{ PLDM_FW_UPDATE_CMD_CODE_VERIFY_COMPLETE, STATE_VERIFY, STATE_APPLY },
	{ PLDM_FW_UPDATE_CMD_CODE_VERIFY_COMPLETE, STATE_VERIFY, STATE_IDLE },

	/* ApplyComplete */
	{ PLDM_FW_UPDATE_CMD_CODE_APPLY_COMPLETE, STATE_APPLY, STATE_APPLY },
	{ PLDM_FW_UPDATE_CMD_CODE_APPLY_COMPLETE, STATE_APPLY, STATE_RDY_XFER },

	/* ActiveFirmware */
	{ PLDM_FW_UPDATE_CMD_CODE_ACTIVE_FIRMWARE, STATE_ACTIVATE, STATE_ACTIVATE },
	{ PLDM_FW_UPDATE_CMD_CODE_ACTIVE_FIRMWARE, STATE_ACTIVATE, STATE_IDLE },
	{ PLDM_FW_UPDATE_CMD_CODE_ACTIVE_FIRMWARE, STATE_RDY_XFER, STATE_ACTIVATE },
	{ PLDM_FW_UPDATE_CMD_CODE_ACTIVE_FIRMWARE, STATE_RDY_XFER, STATE_IDLE },

	/* GetStatus */
	{ PLDM_FW_UPDATE_CMD_CODE_GET_STATUS, STATE_IDLE, STATE_IDLE },
	{ PLDM_FW_UPDATE_CMD_CODE_GET_STATUS, STATE_LEARN_COMP, STATE_LEARN_COMP },
	{ PLDM_FW_UPDATE_CMD_CODE_GET_STATUS, STATE_IDLE, STATE_IDLE },
	{ PLDM_FW_UPDATE_CMD_CODE_GET_STATUS, STATE_RDY_XFER, STATE_RDY_XFER },
	{ PLDM_FW_UPDATE_CMD_CODE_GET_STATUS, STATE_DOWNLOAD, STATE_DOWNLOAD },
	{ PLDM_FW_UPDATE_CMD_CODE_GET_STATUS, STATE_VERIFY, STATE_VERIFY },
	{ PLDM_FW_UPDATE_CMD_CODE_GET_STATUS, STATE_APPLY, STATE_APPLY },
	{ PLDM_FW_UPDATE_CMD_CODE_GET_STATUS, STATE_ACTIVATE, STATE_ACTIVATE },

	/* CancelUpdateComponent */
	{ PLDM_FW_UPDATE_CMD_CODE_CANCEL_UPDATE_COMPONENT, STATE_DOWNLOAD, STATE_RDY_XFER },
	{ PLDM_FW_UPDATE_CMD_CODE_CANCEL_UPDATE_COMPONENT, STATE_VERIFY, STATE_RDY_XFER },
	{ PLDM_FW_UPDATE_CMD_CODE_CANCEL_UPDATE_COMPONENT, STATE_APPLY, STATE_RDY_XFER },

	/* CancelUpdate */
	{ PLDM_FW_UPDATE_CMD_CODE_CANCEL_UPDATE, STATE_LEARN_COMP, STATE_IDLE },
	{ PLDM_FW_UPDATE_CMD_CODE_CANCEL_UPDATE, STATE_RDY_XFER, STATE_IDLE },
	{ PLDM_FW_UPDATE_CMD_CODE_CANCEL_UPDATE, STATE_DOWNLOAD, STATE_IDLE },
	{ PLDM_FW_UPDATE_CMD_CODE_CANCEL_UPDATE, STATE_VERIFY, STATE_IDLE },
	{ PLDM_FW_UPDATE_CMD_CODE_CANCEL_UPDATE, STATE_APPLY, STATE_IDLE },
};
